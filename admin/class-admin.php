...
class CashFlow_Admin {
    ...
    public function enqueue_assets( $hook ) {
        ...
        // Never localize CashFlow_Plugin::get_settings() wholesale, or the
        // connection secret option (cashflow_connection_secret, set separately
        // by /configure): either could carry a sensitive value later. The
        // settings page renders its own values server-side in admin/views/settings.php.
